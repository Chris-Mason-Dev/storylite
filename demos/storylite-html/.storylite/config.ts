...
export default defineConfig({
  ...
  managerHead: '<title>HTML - StoryLite</title><meta name="storylite-demo" content="html">',
  previewHtmlAttrs: (defaults) => ({ ...defaults, 'data-storylite-preview': 'html' }),
  ui: {
    brand: {
      markHtml: '<span style="color: white;">HTML</span>',
      titleHtml: '<strong>HTML</strong>',
    },
    ...
    menuLinks: (defaultLinks) => [
      ...defaultLinks,
      {
        ...
        label: 'Demo source',
        icon: 'external-link',
        href: 'https://github.com/itsjavi/storylite/tree/main/demos/storylite-html',
        target: '_blank',
      },
    ],
  },
